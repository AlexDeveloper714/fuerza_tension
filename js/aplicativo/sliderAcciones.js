...
$(function () {
    ...
    function valueOutput() {
        ...
        switch (angulo) {
            case 0:
                arrow = Vertices.fromPath('0 0 0 50 500 50 500 0');
                triangulo = Bodies.fromVertices(posXtria, posYtria, arrow, {isStatic: true, friction: 0.01});
                ...
                break;
            case 45:
                arrow = Vertices.fromPath('0 0 0 200 200 200');
                triangulo = Bodies.fromVertices(posXtria, posYtria, arrow, {isStatic: true, friction: 0.01});
                ...
                break;
            case 90:
                arrow = Vertices.fromPath('0 0 0 190 190 190 190 0');
                triangulo = Bodies.fromVertices(posXtria + 20, posYtria - 10, arrow, {isStatic: true, friction: 0.01});
                circle = Bodies.circle(posXcir, posYcir - 70, 20, {render: {
                        fillStyle: 'transparent',
                        strokeStyle: 'transparent'
                    }, isStatic: true, friction: 0.01});
            ...
            default:
                if (angulo > 0 && angulo < 45) {
                    ...
                    arrow = Vertices.fromPath('0 ' + a + ' 0 200 200 200');
                    if (angulo > 30) {
                    ...
                    arrow = Vertices.fromPath('0 0 0 200 ' + b + ' 200');
                    difX = posXtria - b;
                    ...
                    triangulo = Bodies.fromVertices(posXtria - difX, posYtria, arrow, {isStatic: true, friction: 0.01});
                    circle = Bodies.circle(posXcir, posYcir - 70, 17, {render: {
                            fillStyle: 'transparent',
                            strokeStyle: 'transparent'
                        }, isStatic: true, friction: 0.01});
        ...
        if (angulo == 0) {
            World.add(engine.world, [triangulo, cadena, circle]);
        } else {
            World.add(engine.world, [triangulo, cadena, circle, circle_2, polea]);
        }
//            // run the engine
        Engine.run(engine);
//            // run the renderer
